...
import 'package:cms/network/network.dart';
import 'package:cms/routes/app_routes.dart' as route;
...
import 'package:cms/helper/snackbar_helper.dart';
import 'package:cms/widgets/logo_widget.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // 1 - Admin, 2 - HR, 3 - Account, 4 - Storkeepar, 5 - Manager, 6 - Team Leader, 7 - Employee

  callScreen() async {
    await SecStore.getValue(keyVal: SharedPreferencesConstant.EMPLOYEETYPEID)
        .then((value) {
      print("value $value");
      if (value == "1") {
