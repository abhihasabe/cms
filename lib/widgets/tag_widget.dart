...
import 'package:cms/theme/app_colors.dart' as colors;
        ...
        child: Row(
          ...
          children: <Widget>[
            TextWidget(
                text: widget.label!,
                small: true,
                textColor: _isActive == true ? colors.backgroundColor : colors.accentColor
            ),
            if (widget.arrow == true) const SizedBox(width: 8),
            if (widget.arrow == true) const Icon(Icons.arrow_drop_down, color: colors.accentColor)
          ],
        ),
      ),
    );
